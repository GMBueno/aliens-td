...
const ui = {
  ...
  towerSidebar: document.querySelector("#tower-sidebar"),
  towerSidebarTitle: document.querySelector("#tower-sidebar-title"),
  towerSidebarCloseButton: document.querySelector("#tower-sidebar-close-button"),
  towerStatList: document.querySelector("#tower-stat-list"),
